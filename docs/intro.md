...
1. Go to the [Registration](https://academy-genie.asterquanta.com/login) page  
...
6. With that, your registration process should be completed and you can login from the [login](https://academy-genie.asterquanta.com/login) page
