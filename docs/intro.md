...
1. Go to the [Registration](https://learning-genie.asterquanta.com/createAccount) page  
...
6. With that, your registration process should be completed and you can login from the [login](https://learning-genie.asterquanta.com/login) page
