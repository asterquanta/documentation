...
The [**Add New Project**](https://academy-genie.asterquanta.com/home/projects/create?kind=0) page allows you to create and save a new project. Whether you're starting from scratch or working with an existing design, this page provides a user-friendly interface to build and organize your project efficiently.
...
## Save Project
Once you have filled out all the required fields, click the **Save Project** button to save your project. Your project will be saved and accessible from your projects list.

> **Note:** After saving, you can publish and authorize your project to make it publicly available. 